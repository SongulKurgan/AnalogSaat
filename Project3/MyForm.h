...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Size = System::Drawing::Size(451, 494);
			...
			this->ClientSize = System::Drawing::Size(730, 564);
	...
	public:
		Graphics^ g;
		int Genislik = 300, Yukseklik = 300, SaniyeIbre = 120, DakikaIbre = 110, SaatIbre = 80;
		int OrtaX, OrtaY;
		Bitmap^ bmp;
#pragma endregion
	...
	private: System::Void timer1_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		g->Clear(Color::White);
		/*Image^ image = Image::FromFile("??C:\\Users\\Asus\\Documents\\resimler\\resim\FLAVZRVECT314201917371_genesis-4500-2-eskitme-duvar-kagidi (1).jpg");
		g->DrawImage(image, 1, 0, image->Size.Width, image->Size.Height);*/
		g->DrawEllipse(gcnew Pen(Color::CadetBlue, 5), 2, 2, Yukseklik - 4, Genislik - 4);
		...
		for (int aci = 0; aci <= 360; aci += 6) {
			...
			if (aci % 30 == 0)
				g->DrawLine(gcnew Pen(Color::Gray, 4), x1, y1, x2, y2);
			else
				g->DrawLine(gcnew Pen(Color::Gray, 1), x1, y1, x2, y2);
		}
		System::Drawing::Font^ drawFont = gcnew System::Drawing::Font("Algerian", 15);
		...
		Pen^ grayPen = gcnew Pen(Color::Red, 2.0f);
